...
namespace GV23_Notice.Services.Email
{
    public sealed class WorkflowApprovalEmailService : IWorkflowApprovalEmailService
    {
        ...
        public (string Subject, string BodyHtml) BuildApprovalEmail(NoticeSettings s, RollRegistry roll, string approvedBy, string kickoffUrl)
        {
            ...
            sb.Append("<p>");
            sb.Append("Step 1 has been <b>APPROVED</b> and the workflow may proceed to <b>Step 3</b> (Data Team processing).");
            sb.Append("</p>");
        ...
        public (string Subject, string BodyHtml) BuildCorrectionEmail(NoticeSettings s, RollRegistry roll, string requestedBy, string reason)
        {
